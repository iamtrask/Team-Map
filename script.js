...
map.on('load', function() {
    map.addSource('source-contribute', {
        type: 'vector',
        url: 'mapbox://4mber.cj70mdg5e074d32lw7e1n5dh1-6axeo'
    });
});

// Creates repo buttons to sort layers:
var toggleableLayerIds = ['Adapters', 'Capsule', 'Docs', 'mine.js', 'openmined.org', 'PyBV', 'PySonar', 'PySyft', 'PyYashe', 'radar.js', 'R-Homomorphic-Encryption-Package', 'Sonar', 'syft.js', 'Team-Map', 'Other Contributions'];
var id = '';
var link = '';
...
map.on('click', function(e) {
    var features = map.queryRenderedFeatures(e.point, {
        layers: ['Other Contributions', 'Adapters', 'Capsule', 'Docs', 'PySonar', 'PySyft', 'PyYashe', 'R-Homomorphic-Encryption-Package', 'Sonar', 'Team-Map', 'mine.js', 'openmined.org', 'syft.js', 'PyBV', 'radar.js']
    });
    if (!features.length) {
        return;
    }
    ...
    if (feature.properties.GitHub.length != 0) {
        ...
        var contributions = [];
        var repos = ['PySyft', 'PySonar', 'Capsule', 'R-Homomorphic-Encryption-Package', 'openmined.org', 'Docs', 'Sonar', 'Adapters', 'mine.js', 'PyYashe', 'syft.js', 'Team-Map', 'PyBV', 'radar.js'];
